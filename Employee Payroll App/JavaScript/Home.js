...
const createInnerHtml = () => {
    ...
    for (let employeerollData of employeePayrollList) {
        innerHtml = `${innerHtml}
        <tr>
        <td><img src ="${employeerollData._profilePic}"></td>
        ...
        <td>
            <img id = "${employeerollData.id}" src="Assets/icons/delete-black-18dp.svg" alt="Delete" onClick=remove(this)>
            <img id = "${employeerollData.id}" src="Assets/icons/delete-black-18dp.svg" alt="Edit" onClick=update(this)>
            </td>
        </tr>`
        ;
    }
